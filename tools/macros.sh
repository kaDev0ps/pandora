...
# Lazy journal
wget https://github.com/Lifailon/lazyjournal/releases/download/0.7.9/lazyjournal-0.7.9-amd64.deb -O lazyjournal.deb && sudo dpkg -i lazyjournal.deb && sudo apt-get install -f
